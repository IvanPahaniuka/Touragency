...
<nav class="border fixed split-nav">
    <div class="nav-brand">
        <h3><a href="sign-up"><fmt:message key="touragency"/></a></h3>
    </div>
    <div class="collapsible">
        ...
        <div class="collapsible-body">
            <ul class="inline">
                <custom:lang path="/touragency/sign-up"/>
            </ul>
        </div>
    </div>
</nav>
...
<div class="paper container">
    <div class="row flex-center">
        <div class="col-fill col">
            ...
            <form action="${pageContext.request.contextPath}/touragency/sign-up" method="post">
